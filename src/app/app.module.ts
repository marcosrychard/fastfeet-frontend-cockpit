...
import { JwtInterceptor } from './shared/helpers/jwt.interceptor.helpers';
import { ErrorInterceptor } from './shared/helpers/error.interceptor.helpers';
...
@NgModule({
  ...
  providers: [
    {
      provide: APP_INITIALIZER, useFactory: InitEnvConfigFactory,
